  ...
  return `<main class="landing-page">
    <section class="landing-hero">
      ...
      <div class="landing-copy">
        ...
        <p>UniBox об'єднує ESP32-симулятор, лабораторні завдання, вимірювання з фізичного набору та автоматичну перевірку в одному робочому просторі.</p>
        <div class="landing-actions"><button class="landing-primary" data-action="show-auth" data-auth-mode="register">Почати безкоштовно</button><button class="landing-secondary" data-action="show-auth" data-auth-mode="login">У мене вже є акаунт</button></div>
        <ul class="landing-proof" aria-label="Можливості платформи"><li><b>ESP32</b><span>візуальна симуляція</span></li><li><b>3 кроки</b><span>від схеми до результату</span></li><li><b>Онлайн</b><span>прогрес завжди під рукою</span></li></ul>
      </div>
      <div class="landing-board" aria-hidden="true"><img class="landing-esp32-image" src="./src/assets/esp32-devkit-hero.png" alt="" /><span class="landing-wire wire-one"></span><span class="landing-wire wire-two"></span><span class="landing-sensor">SENSOR</span></div>
    </section>
    <section class="landing-features" aria-label="Для кого UniBox"><article><span>01</span><h3>Для студентів</h3><p>Покрокові лабораторні, збірка схем та історія результатів.</p></article><article><span>02</span><h3>Симуляція</h3><p>З'єднуйте ESP32 і модулі проводами та перевіряйте схему до експерименту.</p></article><article><span>03</span><h3>Для викладачів</h3><p>Окремий кабінет для контролю активності й прогресу групи.</p></article></section>
    <section class="landing-path"><div class="landing-section-heading"><span>Як це працює</span><h2>Практика без зайвого порогу входу</h2><p>Навчання побудоване як зрозумілий маршрут: спочатку перевіряємо ідею, потім збираємо, вимірюємо та зберігаємо результат.</p></div><ol class="learning-steps"><li><i>01</i><h3>Відкрийте завдання</h3><p>Ознайомтеся з метою лабораторної та критеріями успішного виконання.</p></li><li><i>02</i><h3>Зберіть у симуляторі</h3><p>З'єднайте компоненти на віртуальній ESP32-платі перед роботою з обладнанням.</p></li><li><i>03</i><h3>Перевірте результат</h3><p>Збережіть вимірювання і отримайте автоматичну оцінку своєї спроби.</p></li></ol></section>
    <section class="landing-audience"><article><span class="audience-tag">Студентам</span><h2>Менше теорії в повітрі. Більше власних рішень.</h2><p>Працюйте у своєму темпі, повертайтеся до симуляції та бачте, як кожна дія впливає на результат.</p><button class="audience-link" data-action="show-auth" data-auth-mode="register">Створити профіль <span aria-hidden="true">→</span></button></article><article class="audience-visual" aria-hidden="true"><span>INPUT</span><div class="audience-line"></div><b>ESP32</b><div class="audience-line active"></div><span>RESULT</span></article><article><span class="audience-tag">Викладачам</span><h2>Вся група й прогрес у одному огляді.</h2><p>Призначайте лабораторні, відстежуйте активність і швидко знаходьте тих, кому потрібна підтримка.</p><button class="audience-link" data-action="show-auth" data-auth-mode="register">Створити кабінет <span aria-hidden="true">→</span></button></article></section>
    <section class="landing-final"><div><span>ГОТОВІ ДО ПЕРШОГО ЕКСПЕРИМЕНТУ?</span><h2>Зберіть свою першу ESP32-схему сьогодні.</h2></div><button class="landing-primary" data-action="show-auth" data-auth-mode="register">Розпочати роботу</button></section>
  </main>`;
}
